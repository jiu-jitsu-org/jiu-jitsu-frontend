 ...
 * structured by article headings. Visual primitives live in
 * `./policy-document` so other policy pages share the same look.
 */
export function TermsOfServicePage() {
  return (
    <PolicyDocument title="서비스 이용약관" subtitle="서비스명: OSS">
      <Lead>
        본 약관은 「JiuJitsuLab」(이메일: jiujitsulab.team@gmail.com, 이하
        &quot;운영자&quot;)이 제공하는 주짓수 커뮤니티 서비스 「OSS」(이하
        &quot;서비스&quot;)의 이용과 관련하여 운영자와 이용자 간의 권리·의무
      ...
      <Section title="제2조 (정의)">
        <OrderedList>
          <li>
            ...
            제공하는 콘텐츠 열람 등을 이용할 수 있는 모바일 플랫폼을 의미합니다.
          </li>
          <li>
          ...
          <li>
            ...
            기술·포지션, 지도자 인증 자료 등 이용자가 서비스에 등록·게시한 정보
            일체를 의미합니다.
          </li>
          <li>
            &quot;운영자 콘텐츠&quot;란 운영자가 서비스 내에서 직접
            제작·편집하여 제공하는 게시물, 영상, 이미지, 가이드 등 일체의 정보를
            의미합니다.
          </li>
        </OrderedList>
      </Section>
      ...
      <Section title="제3조 (약관의 효력 및 변경)">
        <OrderedList>
          ...
          <li>
            운영자는 관련 법령을 준수하는 범위 내에서 약관을 변경할 수 있으며,
            변경 시 최소 7일(이용자에게 불리한 변경의 경우 30일) 전에 서비스
            내에 공지합니다.
          </li>
          <li>
      ...
      <Section title="제4조 (회원가입)">
        <OrderedList>
          <li>
            이용자는 Google, Apple, Kakao 계정을 통한 소셜 로그인으로 회원가입할
            수 있으며, 가입 절차는 약관 동의 및 닉네임 설정으로 완료됩니다.
          </li>
          ...
          <li>
            ...
            <UnorderedList>
              ...
              <li>
                허위 정보를 제공한 경우(벨트, 대회 기록, 도장 소속, 지도자 자격
                등)
              </li>
      ...
      <Section title="제5조 (서비스 제공)">
        <p>서비스는 주짓수 커뮤니티를 중심으로 다음과 같은 기능을 제공합니다.</p>
        <OrderedList>
          <li>
          ...
          <li>
            <strong>운영자 제공 콘텐츠</strong> — 운영자가 제작·큐레이션한 주짓수
            관련 게시물·영상·가이드 등의 열람
          </li>
          <li>
      ...
      <Section title="제7조 (이용자의 의무)">
        <OrderedList>
          ...
          <li>
            이용자의 위반 행위로 인해 발생한 모든 책임은 이용자 본인에게 있으며,
            운영자는 해당 책임을 부담하지 않습니다.
          </li>
        </OrderedList>
      </Section>
      ...
      <Section title="제8조 (콘텐츠 및 프로필 관리)">
        <OrderedList>
          <li>
            ...
            가이드라인에 위반될 경우 운영자는 사전 통지 없이 해당 게시물·항목을
            비공개 처리·삭제하거나 이용을 제한할 수 있습니다.
          </li>
          <li>
            운영자는 지도자 인증 자료가 위·변조되었거나 자격이 더 이상 유효하지
            않은 것으로 확인된 경우 인증을 회수할 수 있습니다.
          </li>
          <li>
      ...
      <Section title="제9조 (저작권)">
        <OrderedList>
          ...
          <li>
            운영자는 서비스 운영, 화면 노출, 검색·추천 기능 제공 및 서비스 홍보
            범위 내에서 이용자 콘텐츠를 별도의 대가 없이 사용할 수 있습니다. 단,
            상업적 2차 가공 또는 제3자에 대한 별도 제공은 이용자의 동의를
            받습니다.
          </li>
          <li>
            운영자 콘텐츠의 저작권 및 기타 일체의 권리는 운영자에게 귀속되며,
            이용자는 개인적·비상업적 열람 목적 외에 이를 복제·배포·전송·2차
            가공할 수 없습니다.
          </li>
          <li>
      ...
      <Section title="제10조 (회원 탈퇴 및 이용 제한)">
        <OrderedList>
          ...
          <li>
            탈퇴 시 개인정보 및 등록 정보는 개인정보처리방침이 정하는 바에 따라
            즉시 파기되며, 다만 부정 이용 방지 및 관련 법령에 따른 보존 의무가
            있는 항목은 일정 기간 보관될 수 있습니다.
          </li>
          <li>
      ...
      <Section title="제11조 (푸시 알림 및 마케팅 정보)">
        <OrderedList>
          ...
          <li>
            마케팅 및 광고성 정보의 수신은 이용자의 별도 동의를 받아 발송되며,
            이용자는 언제든 앱 내 알림 설정에서 수신을 해제할 수 있습니다.
          </li>
        </OrderedList>
      </Section>
      ...
      <Section title="제12조 (면책조항)">
        <OrderedList>
          ...
          <li>
            이용자가 서비스를 통해 알게 된 다른 이용자, 도장, 지도자와의 오프라인
            만남, 스파링, 세미나, 대회 참가 등에서 발생한 부상·사고에 대해
            운영자는 일체 책임을 지지 않습니다.
          </li>
          <li>
            등록된 도장·지도자 정보의 최종 검증 책임은 이를 이용하는 이용자에게
            있으며, 지도자 인증 마크는 제출된 자료에 대한 운영자의 확인을
            의미할 뿐 해당 지도자의 자격 유효성·도장의 운영 품질을 보증하지
            않습니다.
          </li>
          <li>
            운영자 콘텐츠는 일반적인 정보 제공을 목적으로 하며, 이를 실제 훈련에
            적용함에 따라 발생하는 부상·사고에 대해 운영자는 책임지지 않습니다.
          </li>
          <li>
